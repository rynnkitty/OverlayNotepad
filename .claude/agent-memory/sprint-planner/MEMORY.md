...
- [현재 스프린트 상태](project_sprint_status.md) — Phase 1~4 전체 Sprint 계획 수립 완료, 구현 시작 전
...
- [Phase 4 Sprint 1 계획](project_phase4_sprint1.md) — 글로벌 핫키 + Click-Through (WS_EX_TRANSPARENT), 계획 완료
