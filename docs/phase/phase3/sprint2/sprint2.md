...
**브랜치명:** `phase3-sprint2`
**PR:** https://github.com/rynnkitty/OverlayNotepad/compare/develop...phase3-sprint2
...
- ✅ MSBuild 빌드 성공 (Debug + Release 모두 0 Errors)
...
- ✅ 테마 전환 토글 동작
- ✅ 테두리 색상 변경 + 저장 (InitializeColorMenu 헬퍼로 중복 제거)
- ✅ 자동저장 상태 표시
- ✅ 최소화 -> 트레이 숨김 동작
- ✅ 서브메뉴 깊이 1단계 이내
- ✅ MSBuild 빌드 성공
...
- ✅ 시작 시간 2초 이내
- ✅ 메모리 80MB 이하
- ✅ MSBuild 빌드 성공 (Debug + Release 0 Errors)
