...
- 전체 진행률: Phase 1/4 진행 중 (Sprint 1 완료)
- 현재 Phase: Phase 1 진행 중 (Sprint 1 완료, Sprint 2 예정), Phase 2~4 계획 수립 완료
- 완료된 스프린트: Phase 1 Sprint 1 (2026-04-17)
...
### 작업 목록
#### Sprint 1: WPF 프로젝트 구조 + 투명 윈도우 + 기본 텍스트 입력 ✅
...
- WindowChrome 또는 커스텀 리사이즈 핸들로 윈도우 크기 조절
- 표준 TextBox 배치 및 투명 배경 위 텍스트 입력 동작 확인
- 한글/영문 IME 입력 정상 동작 확인

#### Sprint 2: 투명도 모드 + Always on Top 🔄
...
| 마일스톤 | Phase | 핵심 성과 | 상태 |
|---------|-------|----------|------|
| P0 기초 | Phase 1 | WPF 투명 윈도우 + 텍스트 입력 동작 | 📋 예정 |
| P0 완성 | Phase 2 | 텍스트 테두리/그림자 + 자동 저장 + 윈도우 관리 | 📋 예정 |
